...
$hitung=mysqli_query($GLOBALS["___mysqli_ston"], "select * from tb_ikk_bidang where id_bidang='".$_SESSION['id_bidang']."' and tri1=1 and tahun='$_SESSION[tahun]'");
...
?>  
 <section class="header">
	...
	<font style="font-size:14px" class="box-title"></a><i class="fa fa-database"></i><b> Daftar IKK Bidang Tahun <?php echo $_SESSION['tahun'] ?> (Triwulan 1)</b></font>  
	<?php
	if ($jumlah_record!=0){
	?>
	<div class="box-tools pull-right">
	<button onClick="cetakcapaian1()"  class="btn btn-primary" style="font-size:12px"><i class="fa fa-print"></i> Cetak Capaian</button></a> 
	</div> 
	<?PHP
	}
	?>
	...
	<table cellspacing="0"  cellpadding="2" border="1" width="100%"> 
		...
		$no==0;
		$data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from tb_ikk_bidang where id_bidang='".$_SESSION['id_bidang']."' and tri1=1 and tahun='$_SESSION[tahun]' order by id_data asc");
		...
		$nilai=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from tb_nilai_ikk_tri1 where id_ikk='".$cekdata['id_ikk']."' and id_bidang='".$_SESSION['id_bidang']."' and triwulan=1 and tahun='".$_SESSION['tahun']."'"));  
		?>
		<tr style="font-size:12px">  
		...
		?>
		  <td align=center style=padding:8px 10px;> 
		 <button type="button" onClick="inputpembilang(<?php echo $cekdata['id_ikk'] ?>)"  title="Input Angka" class="btn btn-info  btn-xs"><i class="fa fa-edit"></i></button>
		 </td> 
		 <?PHP
		}else{
		?>
		...
		?>
		 <td align=center style=padding:8px 10px;> 
		 <button type="button" onClick="inputpembagi(<?php echo $cekdata['id_ikk'] ?>)"  title="Input Angka"  class="btn btn-info  btn-xs"><i class="fa fa-edit"></i></button>
		 </td> 
		 <?PHP
		}else{
		?>
 ...
 <div class="card card-default"> 
	<div class="box box-solid box-light"> 
	<div class="box-header">  
	<font style="font-size:14px" class="box-title"></a><i class="fa fa-folder-open"></i><b> Daftar Data Dukung Tahun <?php echo $_SESSION['tahun'] ?> (Triwulan 1)</b></font>  
	</div>
	<div class="card-body"> 
	<form enctype="multipart/form-data" class="form-horizontal" method="post"/>  
	</table>
