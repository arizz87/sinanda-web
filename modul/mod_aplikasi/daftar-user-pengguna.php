	...
	<div class="card card-default"> 
              <div class="box box-solid box-success"> 
				 <div class="box-header">
                                     <font style="font-size:14px" class="box-title"></a><i class="fa fa-list"></i><b> DAFTAR USER PENGGUNA TAHUN <?php echo $_SESSION['tahun'];?></b></font>
                                    <div class="box-tools pull-right">
									 	<button onClick="tambahdata()"  class="btn btn-danger" style="font-size:13px"><i class="fa fa-plus"></i> Tambah User</button></a>  
									</div>  
									</div><!-- /.box-header -->
                <div class="box-body">
				    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						<thead>
							<tr>
								...
								<th style="width:25%;"><center>Nama Pengguna</center></th>
								<th style="width:28%;"><center>Nama Bidang</center></th> 
								<th style="width:12%;"><center>Level</center></th> 
...
<script type="text/javascript" language="javascript" >
                                ...
                                $(document).ready(function() {
                                    dTable = $('#example').DataTable( {
                                        ...
                                        "bJQueryUI": false,
                                        "responsive": true,
                                        "sAjaxSource": "modul/mod_aplikasi/serverSidepengguna.php", // Load Data
                                        "sServerMethod": "POST",
