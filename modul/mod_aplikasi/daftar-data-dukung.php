...
<script src="modul/js/sinanda-daftardatadukung.js"></script>
</HEAD>
<BODY>  
<?php  
$tglusul=date('d-m-Y');	
	...
	<div class="card card-default"> 
              <div class="box box-solid box-success"> 
				 <div class="box-header">
                                     <font style="font-size:14px" class="box-title"></a><i class="fa fa-list"></i><b> DAFTAR DATA DUKUNG TAHUN <?php echo $_SESSION['tahun'];?></b></font>
				    ...
				    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						<thead>
							<tr>
								...
								<th style="width:63%;"><center>Uraian Data Dukung</center></th>
								<th style="width:20%;"><center>Kode Data</center></th> 
...
<script type="text/javascript" language="javascript" >
                                ...
                                $(document).ready(function() {
                                    dTable = $('#example').DataTable( {
                                        ...
                                        "bJQueryUI": false,
                                        "responsive": true,
                                        "sAjaxSource": "modul/mod_aplikasi/serverSidedatadukung.php", // Load Data
                                        "sServerMethod": "POST",
