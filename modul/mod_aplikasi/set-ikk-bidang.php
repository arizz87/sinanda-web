	...
	<div class="card card-default"> 
              <div class="box box-solid box-success"> 
				 <div class="box-header">
                                     <font style="font-size:14px" class="box-title"></a><i class="fa fa-list"></i><b> DAFTAR BIDANG TEKNIS TAHUN <?php echo $_SESSION['tahun'];?></b></font>
				    ...
				    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						<thead>
							<tr>
								...
								<th style="width:32%;"><center>Nama Bidang</center></th>
								<th style="width:12%;"><center>Jumlah Data IKK</center></th> 
								<th style="width:12%;"><center>Jumlah Data Dukung</center></th> 
								<th style="width:18%;"><center>Daftar Data IKK dan Data Dukung</center></th>  
...
<script type="text/javascript" language="javascript" >
                                ...
                                $(document).ready(function() {
                                    dTable = $('#example').DataTable( {
                                        ...
                                        "bJQueryUI": false,
                                        "responsive": true,
                                        "sAjaxSource": "modul/mod_aplikasi/serverSidesetbidang.php", // Load Data
                                        "sServerMethod": "POST",
