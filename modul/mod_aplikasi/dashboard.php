...
$phitung1=mysqli_query($GLOBALS["___mysqli_ston"], "select * from tb_nilai_ikk_tri1,tb_ikk_bidang where tb_ikk_bidang.id_ikk=tb_nilai_ikk_tri1.id_ikk and tb_nilai_ikk_tri1.id_bidang='$_SESSION[id_bidang]' and tb_nilai_ikk_tri1.tahun='$_SESSION[tahun]' and tb_nilai_ikk_tri1.triwulan=1 and tb_ikk_bidang.tri1=1");
...
$persentotaldukungtri11=round($persentotaldukungtri1x,2); 

if($jumlah_recorddukung1x==0){
$persentotaldukungtri1=0;	
}else{
$persentotaldukungtri1=round($persentotaldukungtri11,2);	
}
...
$phitung2=mysqli_query($GLOBALS["___mysqli_ston"], "select * from tb_nilai_ikk_tri1,tb_ikk_bidang where tb_ikk_bidang.id_ikk=tb_nilai_ikk_tri1.id_ikk and tb_nilai_ikk_tri1.id_bidang='$_SESSION[id_bidang]' and tb_nilai_ikk_tri1.tahun='$_SESSION[tahun]' and tb_nilai_ikk_tri1.triwulan=2 and tb_ikk_bidang.tri2=1");
...
$persentotaldukungtri22=round($persentotaldukungtri2x,2); 

if($jumlah_recorddukung2x==0){
$persentotaldukungtri2=0;	
}else{
$persentotaldukungtri2=round($persentotaldukungtri22,2);	
}
...
$phitung3=mysqli_query($GLOBALS["___mysqli_ston"], "select * from tb_nilai_ikk_tri1,tb_ikk_bidang where tb_ikk_bidang.id_ikk=tb_nilai_ikk_tri1.id_ikk and tb_nilai_ikk_tri1.id_bidang='$_SESSION[id_bidang]' and tb_nilai_ikk_tri1.tahun='$_SESSION[tahun]' and tb_nilai_ikk_tri1.triwulan=3 and tb_ikk_bidang.tri3=1");
...
$persentotaldukungtri33=round($persentotaldukungtri3x,2); 

if($jumlah_recorddukung3x==0){
$persentotaldukungtri3=0;	
}else{
$persentotaldukungtri3=round($persentotaldukungtri33,2);	
}
...
$phitung4=mysqli_query($GLOBALS["___mysqli_ston"], "select * from tb_nilai_ikk_tri1,tb_ikk_bidang where tb_ikk_bidang.id_ikk=tb_nilai_ikk_tri1.id_ikk and tb_nilai_ikk_tri1.id_bidang='$_SESSION[id_bidang]' and tb_nilai_ikk_tri1.tahun='$_SESSION[tahun]' and tb_nilai_ikk_tri1.triwulan=4 and tb_ikk_bidang.tri4=1");
...
$persentotaldukungtri44=round($persentotaldukungtri4x,2); 

if($jumlah_recorddukung4x==0){
$persentotaldukungtri4=0;	
}else{
$persentotaldukungtri4=round($persentotaldukungtri44);	
}
...
?>   
 <section class="header">
          <ol class="breadcrumb" style="background-color:#E6E6E2">
            <li> 
						 <font style="font-size:18px;color:black"><b><?php echo $data['nama_bidang'] ?> </font>
						<font style="font-size:12px;color:black"><br><i>Tanggal Login : <?php
	 ...
	 <div class="card">
		   ...
		   <div class="col-lg-6 col-6">
			...
			<div class="inner">  
			 ...
			 <font style=color:#20B2AA><i class="fas fa-5x fa-database"></i></font>
			  </p>&nbsp;&nbsp; 
		   ...
		   <div class="col-lg-6 col-6">
			...
			<div class="inner">  
             ...
             <div class="small-box bg-success">
              ...
              <div class="overlay">
			  <p class="text-light text-x1 animate__animated animate__rubberBand"> 
			  <font style=color:#895989><i class="fas fa-5x fa-database"></i></font>
			  </p>&nbsp;&nbsp; 
		   ...
		   <div class="col-lg-6 col-6">
			...
			<div class="inner">  
             ...
             <div class="small-box bg-success">
              ...
              <div class="overlay">
			  <p class="text-light text-x1 animate__animated animate__rubberBand"> 
			<font style=color:#be5555;><i class="fas fa-5x fa-database"></i></font>
			  </p>&nbsp;&nbsp; 
		   ...
		   <div class="col-lg-6 col-6">
			...
			<div class="inner">  
             ...
             <div class="small-box bg-success">
              ...
              <div class="overlay">
			  <p class="text-light text-x1 animate__animated animate__rubberBand"> 
			 <font style=color:#366ba4><i class="fas fa-5x fa-database"></i></font>
			  </p>&nbsp;&nbsp;
