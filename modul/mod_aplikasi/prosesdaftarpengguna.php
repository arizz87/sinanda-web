...
$rs = mysqli_query($GLOBALS["___mysqli_ston"],"select * from tb_user where kode_user='$id_dok'");
		  ...
		  <font style="font-size:13px" color="black">
						<div class="form-group row"> 
                          <div class="col-sm-12">Username
                            <input type="text" class="form-control" id="username" name="username" autocomplete="off" style="font-size:13px" value="<?php echo $item['username'] ?>">
                          </div>  					  
                        </div>   
						<div class="form-group row"> 
                          <div class="col-sm-12">Password
                            <input type="text" class="form-control" id="passw"  name="passw" autocomplete="off" style="font-size:13px" value="<?php echo $item['password'] ?>">
                          </div>  					  
                        </div>     
						<div class="form-group row"> 
                          <div class="col-sm-12">Nama Pengguna
                            <input type="text" class="form-control" id="nama"  name="nama" autocomplete="off" style="font-size:13px" value="<?php echo $item['nama_pengguna'] ?>">
                          </div>  					  
                        </div>   
						<div class="form-group row"> 
                          <div class="col-sm-9">Nama Bidang
                           <select class="form-control" name="bidang" id="bidang" style="font-size:13px">
							  <option value=""> </option>
                                  <?php 
									$bidang=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tb_bidang ");
                                      while($array_bidang=mysqli_fetch_array($bidang)){
                                        echo "
										<option value=\"$array_bidang[id_bidang]\">$array_bidang[nama_bidang]</option>\n";
                                      } 
                                  ?>
                          ...
                          <div class="col-sm-3">Level
                           <select class="form-control" name="level" id="level" style="font-size:13px">
							  <option value=""> </option>
...
?> 
		  ...
		  <div class="modal-body"> 
			<form enctype="multipart/form-data" class="form-horizontal" method="post"  name="formDetail" id="formDetail">   
			<input type="hidden" class="form-control" id="idupdate" name="idupdate" value="<?php echo $item['kode_user'] ?>"> 
		<div class="row">
          <!-- left column -->
          <div class="col-md-12">
		  <div class="card card-info"> 
		 ...
		 <font style="font-size:13px" color="black">
						...
						<div class="form-group row"> 
                          <div class="col-sm-12">Password
                            <input type="text" class="form-control" id="passw"  name="passw" placeholder="* Kosongkan jika tidak merubah Password" autocomplete="off" style="font-size:13px">
                          </div>  					  
                        </div>     
						<div class="form-group row"> 
                          <div class="col-sm-12">Nama Pengguna
						...
						<div class="form-group row"> 
                          <div class="col-sm-9">Nama Bidang
                           <select class="form-control" name="bidang" id="bidang" style="font-size:13px">
							  <option value=""> </option> 
								 <?php
								 $cek=mysqli_query($con,"SELECT * FROM tb_bidang");
									 while($data=mysqli_fetch_array($cek)){
									 if ($item['id_bidang']==$data['id_bidang']){
								   echo "<option value='$data[id_bidang]' selected>$data[nama_bidang]</option>";
									 }else{
...
?> 
	...
	<div class="card card-info"> 			 
		  ...
		  <font style="font-size:13px" color="black">
						<div class="form-group row"> 
                          <div class="col-sm-12">Username
                            <input type="text" class="form-control" disabled autocomplete="off" style="font-size:13px" value="<?php echo $item['username'] ?>">
                          </div>  					  
                        </div>   
						<div class="form-group row"> 
                          <div class="col-sm-12">Nama Pengguna
                            <input type="text" class="form-control" disabled autocomplete="off" style="font-size:13px" value="<?php echo $item['nama_pengguna'] ?>">
                          </div>  					  
                        </div>   
						<div class="form-group row"> 
                          <div class="col-sm-9">Nama Bidang
                           <select class="form-control" disabled style="font-size:13px">
							  <option value=""> </option> 
								 <?php
								 $cek=mysqli_query($con,"SELECT * FROM tb_bidang");
									 while($data=mysqli_fetch_array($cek)){
