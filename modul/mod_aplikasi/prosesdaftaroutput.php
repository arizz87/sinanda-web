...
$(function(){
		$("#kategori").click(function(){ 
			if(!this.form.kategori.checked){ 
				$("#pembagi").val("").attr("disabled","true");
				$("#pembilang").val("").attr("disabled","true"); 
			}else{ 
				$("#pembagi").val("").removeAttr( "disabled" ); 
				$("#pembilang").val("").removeAttr( "disabled" );  
			} 
		});
	});
...
$rs = mysqli_query($GLOBALS["___mysqli_ston"],"select * from tb_output_ikk where id_outcome='$id_dok'");
		...
		<div class="row">
		  ...
		  <font style="font-size:13px" color="black">
						<div class="form-group row"> 
                          <div class="col-sm-12">Uraian IKK Output
                           <textarea class="form-control" id=uraian name=uraian rows=2 placeholder="Masukan Uraian IKK Outcome" style="font-size:14px"><?php echo $item['uraian_outcome'] ?></textarea>
                          </div>  					  
                        </div>
						<div class="form-group row"> 
                          <div class="col-sm-12"> 
						...
						<div class="form-group row"> 
                          ...
                          <select class="form-control select2" disabled style="font-size:14px;width:100%" name="pembilang" id="pembilang">
							  <option value="">-- Pilih Uraian Data --</option>
								  <?php
									  $jenis=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM  tb_ouput_data order by kode_data asc");
...
$rs = mysqli_query($GLOBALS["___mysqli_ston"],"select * from tb_output_ikk where id_output='$id_dok'");
$item = mysqli_fetch_array($rs);  
...
?> 
		  ...
		  <div class="modal-body"> 
			<form enctype="multipart/form-data" class="form-horizontal" method="post"  name="formDetail" id="formDetail">   
			<input type="hidden" class="form-control" id="idupdate" name="idupdate" value="<?php echo $item['id_output'] ?>"> 
		<div class="row">
          <!-- left column -->
          <div class="col-md-12">
		  <div class="card card-info"> 
		  ...
		  <font style="font-size:13px" color="black">
						<div class="form-group row"> 
                          <div class="col-sm-12">Uraian IKK Output
                           <textarea class="form-control" id=uraian name=uraian rows=2 style="font-size:14px"><?php echo $item['uraian_output'] ?></textarea>
                          </div>  					  
                        </div>   
						<div class="form-group row"> 
                          <div class="col-sm-12">Rumus Pembilang
                            <textarea class="form-control" id=pembilang name=pembilang rows=2 style="font-size:14px"><?php echo $item['pembilang'] ?></textarea>
                          </div>  					  
                        </div>   
						<div class="form-group row"> 
                          <div class="col-sm-12">Rumus Pembagi 
                            <textarea class="form-control" id=pembagi name=pembagi rows=2 style="font-size:14px"><?php echo $item['pembagi'] ?></textarea>
                          </div>  					  
                        </div>
					 </font>
            <!-- /.row -->
...
?> 
	...
	<div class="card card-info"> 			 
		  ...
		  <font style="font-size:13px" color="black">
						<div class="form-group row"> 
                          <div class="col-sm-12">Uraian IKK Output
                           <textarea class="form-control" disabled rows=2 style="font-size:14px"><?php echo $item['uraian_output'] ?></textarea>
                          </div>  					  
                        </div>   
						<div class="form-group row"> 
                          <div class="col-sm-12">Rumus Pembilang
                            <textarea class="form-control" disabled name=pembilang rows=2 style="font-size:14px"><?php echo $item['pembilang'] ?></textarea>
                          </div>  					  
                        </div>   
						<div class="form-group row"> 
                          <div class="col-sm-12">Rumus Pembagi 
                            <textarea class="form-control" disabled name=pembagi rows=2 style="font-size:14px"><?php echo $item['pembagi'] ?></textarea>
                          </div>  					  
                        </div>
					 </font>
            <!-- /.row -->
