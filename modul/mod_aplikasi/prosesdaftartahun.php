...
$rs = mysqli_query($GLOBALS["___mysqli_ston"],"select * from tb_tahun where id_tahun='$id_dok'");
		  ...
		  <font style="font-size:13px" color="black">
						<div class="form-group row"> 
                          <div class="col-sm-12">Tahun Anggaran
                            <input type="text" class="form-control" id=tahun name=tahun autocomplete="off" maxlength=4 onkeypress="return numbersonly(this, event)" style="font-size:13px" value="<?php echo $item['tahun_anggaran'] ?>">
                          </div>  					  
                        </div>   
						<div class="form-group row"> 
                          <div class="col-sm-12">Nama Kepala Instansi 
                            <input type="text" class="form-control" id=namakepala  name=namakepala autocomplete="off" style="font-size:13px" value="<?php echo $item['nama_kepala'] ?>">
                          </div>  					  
                        </div>   
						<div class="form-group row"> 
                          <div class="col-sm-8">NIP Kepala Instansi 
...
?> 
		  ...
		  <div class="modal-body"> 
			<form enctype="multipart/form-data" class="form-horizontal" method="post"  name="formDetail" id="formDetail">   
			<input type="hidden" class="form-control" id="idupdate" name="idupdate" value="<?php echo $item['id_tahun'] ?>"> 
		<div class="row">
          <!-- left column -->
          <div class="col-md-12">
		  <div class="card card-info"> 
	...
	<div class="card card-info"> 			 
          <div class="card-body">
		   <font style="font-size:13px" color="black">
						<div class="form-group row"> 
                          <div class="col-sm-12">Tahun Anggaran
                            <input type="text" class="form-control" disabled autocomplete="off" style="font-size:13px" value="<?php echo $item['tahun_anggaran'] ?>">
                          </div>  					  
                        </div>   
						<div class="form-group row"> 
                          <div class="col-sm-12">Nama Kepala Instansi 
                            <input type="text" class="form-control" disabled autocomplete="off" style="font-size:13px" value="<?php echo $item['nama_kepala'] ?>">
                          </div>  					  
                        </div>   
						<div class="form-group row"> 
                          <div class="col-sm-8">NIP Kepala Instansi 
                            <input type="text" class="form-control" disabled autocomplete="off" style="font-size:13px" value="<?php echo $item['nip'] ?>">
                          </div>  
                          <div class="col-sm-4">Status
