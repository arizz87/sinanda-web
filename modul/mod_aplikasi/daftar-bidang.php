              ...
              <div class="box box-solid box-success"> 
				 <div class="box-header">
                                    ...
                                    <div class="box-tools pull-right">
									 	<button onClick="tambahdata()"  class="btn btn-danger" style="font-size:13px"><i class="fa fa-plus"></i> Tambah Bidang</button></a>  
									</div>  
									</div><!-- /.box-header -->
                <div class="box-body">
				    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						<thead>
							<tr>
								...
								<th style="width:43%;"><center>Nama Bidang</center></th>
								<th style="width:40%;"><center>Nama Kepala Bidang</center></th> 
...
<script type="text/javascript" language="javascript" >
                                ...
                                $(document).ready(function() {
                                    dTable = $('#example').DataTable( {
                                        ...
                                        "bJQueryUI": false,
                                        "responsive": true,
                                        "sAjaxSource": "modul/mod_aplikasi/serverSidedatabidang.php", // Load Data
                                        "sServerMethod": "POST",
