...
<script src="modul/js/sinanda-daftarikkoutput.js"></script>
</HEAD>
<BODY>  
<?php  
$tglusul=date('d-m-Y');	
	...
	<div class="card card-default"> 
              <div class="box box-solid box-success"> 
				 <div class="box-header">
                                     <font style="font-size:14px" class="box-title"></a><i class="fa fa-book"></i><b> DAFTAR IKK OUTPUT <?php echo $_SESSION['tahun'];?></b></font>
				    ...
				    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						<thead>
							<tr>
								...
								<th style="width:43%;"><center>Uraian Output</center></th>
								<th style="width:40%;"><center>Rumus</center></th> 
...
<script type="text/javascript" language="javascript" >
                                ...
                                $(document).ready(function() {
                                    dTable = $('#example').DataTable( {
                                        ...
                                        "bJQueryUI": false,
                                        "responsive": true,
                                        "sAjaxSource": "modul/mod_aplikasi/serverSideikkoutput.php", // Load Data
                                        "sServerMethod": "POST",
